...
public class Encripter {
    ...
    private static final String SECRET_KEY = "miClaveSecretaMuyLarga123!";
    ...
    /**
     * Método de ejemplo para probar la encriptación y desencriptación
     */
    public static void main(String[] args) {
        try {
            ...
            // Verificar que coincide con la original
            System.out.println("¿Coinciden las contraseñas? " + password.equals(decryptedPassword));
        } catch (Exception e) {
